...
export const TEAM_API = 'https://stage-team.andersenlab.com/api';
export const PORTAL_API = 'https://stage-portal.andersenlab.com/api';
export const ASSESSMENT_API = 'https://stage-assessment.andersenlab.com/api';
export const GA_TRACKING_ID = '';
export const COMPANY_NAME = 'Andersen';
export const COMPANY_FULLNAME = 'Andersenlab';
export const COMPANY_URL = 'dev-stage.andersenlab.com';
...
export const SHOW_COMPANY_MERCH = true;
