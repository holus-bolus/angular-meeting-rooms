...
export const TEAM_API = 'https://dev-qa-team.andersenlab.com/api';
export const PORTAL_API = 'https://dev-qa-portal.andersenlab.com/api';
export const ASSESSMENT_API = 'https://dev-qa-assessment.andersenlab.com/api';
export const GA_TRACKING_ID = '';
export const COMPANY_NAME = 'Andersen';
export const COMPANY_FULLNAME = 'Andersenlab';
export const COMPANY_URL = 'dev-qa.andersenlab.com';
