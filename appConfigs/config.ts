...
// export const TEAM_API = 'https://dev-team.andersenlab.com/api';
export const TEAM_API = '';
// export const PORTAL_API = 'https://dev-portal.andersenlab.com/api';
export const PORTAL_API = '';
export const ASSESSMENT_API = 'https://dev-assessment.andersenlab.com/api';
export const GA_TRACKING_ID = '';
export const COMPANY_NAME = 'Andersen';
export const COMPANY_FULLNAME = 'Andersenlab';
export const COMPANY_URL = 'dev.andersenlab.com';
